...
from src.elasticsearch import create_and_update_index, call_ref
...
# Printing the domian and session details in docker(optional)
print("Domain: {domain:}\nSession: {session:}\nURI Prefix: {uri_prefix:}".format(**client.__dict__))

# Set the timeout to 60 seconds, seems optional    
client.timeout = 60 
